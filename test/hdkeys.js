...
var HDPrivateKey = btxcore.HDPrivateKey;
var HDPublicKey = btxcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = btxcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(btxcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(btxcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      btxcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = btxcore.PublicKey.fromPoint;
      btxcore.PublicKey.fromPoint = function() {
        btxcore.PublicKey.fromPoint = unstubbed;
