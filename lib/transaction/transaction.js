 ...
 * and a slightly fancier format recognized by btxcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a btxcore Address object. The
 * same is true for `script`, which can be a string or a btxcore Script.
 *
